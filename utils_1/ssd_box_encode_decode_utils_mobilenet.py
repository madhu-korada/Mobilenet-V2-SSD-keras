...
class SSDBoxEncoder:
    ...
    def __init__(self,
        ...
        print 'two boxes for ar 1 ', two_boxes_for_ar1
        ...
        if aspect_ratios_per_layer:
            ...
            self.n_boxes = []
            for aspect_ratios in aspect_ratios_per_layer:
                if (1 in aspect_ratios) & (two_boxes_for_ar1[count] == 1):
                    self.n_boxes.append(len(aspect_ratios) + 1)
                    count = count +1
                else:
                    self.n_boxes.append(len(aspect_ratios))
        else:
            if (1 in aspect_ratios_global) & (two_boxes_for_ar1[i] == 1):
        ...
        for i in range(len(self.predictor_sizes)):
            boxes, center, wh, step, offset = self.generate_anchor_boxes_for_layer(count,
    ...
    def generate_anchor_boxes_for_layer(self,
        ...
        for ar in aspect_ratios:
            if (ar == 1):
                ...
                if (self.two_boxes_for_ar1[count] ==1 ):
